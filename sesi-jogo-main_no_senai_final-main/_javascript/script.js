...
function escolhaPersonagem(personagem) {
    ...
    switch (personagem) {
        case 'mario':
            ...
            break;
        case 'sonic':
            gameBoard.style.background = "linear-gradient( #002f75ff, #0067ff, #5e9effff )"
            ...
            break;
        case 'dexter':
            gameBoard.style.background = "linear-gradient( #13465aff, #307fad, #000000ff )"
        ...
        case 'osso':
            ...
            gameBoard.style.background = " linear-gradient( #0f7b0bff, #074615ff, #000000)"
